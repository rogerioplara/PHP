                ...
                <div class="row justify-content-center">
                    <div class="col-8">
                        ...
                        <form action="#" method="post">
                            ...
                            <p class="mb-3">Introduza os dados da <strong>nova senha</strong>.</p>
                            ...
                            <div class="mb-3">
                                <label for="text_repeat_new_password" class="form-label">Repetir a nova senha</label>
                                <input type="password" name="text_repeat_new_password" id="text_repeat_new_password" class="form-control" required>
                            </div>

                            <div class="mb-3 text-center">
                                <button type="submit" class="btn btn-secondary"><i class="fa-solid fa-key me-2"></i>Definir senha</button>
                            </div>
